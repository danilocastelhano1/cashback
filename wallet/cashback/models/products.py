...
class Products(BaseModel):
    ...
    cashback = models.ForeignKey(to=Cashback, related_name="products", on_delete=models.CASCADE, null=False,
                                  blank=False)
    type = models.CharField(max_length=11, null=False, blank=False, choices=TYPES_CHOICES)
